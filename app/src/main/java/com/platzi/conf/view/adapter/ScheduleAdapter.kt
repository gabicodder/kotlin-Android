...
class ScheduleAdapter(val scheduleListener: ScheduleListener): RecyclerView.Adapter<ScheduleAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ScheduleAdapter.ViewHolder, position: Int) {
        ...
        holder.tcConferenceTag.text = conference.tag
        ...
        holder.tvConferenceHora.text = hourFormat
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        val tcConferenceTag = itemView.findViewById<TextView>(R.id.tvItemScheduleTag)
        val tvConferenceHora = itemView.findViewById<TextView>(R.id.tvItemScheduleHora)
